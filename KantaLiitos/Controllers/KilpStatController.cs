...
{
    public class KilpStatController : ApiController
    {
        // GET api/<controller>
        [HttpGet]
        public string Get()
        ...
        [HttpGet]
        public KilpStat[] Get(string id)
        {
            KilpStat[] res = new KilpStat[103];
            ...
            if (osat[0] == "1")
            {
                commandText = "dbo.SelectKilpStat";
            ...
            {
                commandText = "dbo.SelectKilpStatLkm";
                SqlParameter par1 = new SqlParameter("@Cus", osat[1]);
                SqlParameter par2 = new SqlParameter("@Hevosid", Convert.ToInt32(osat[2]));
                pars = new SqlParameter[]
                {
            ...
            {
                commandText = "dbo.SelectKilpStatAika";
            ...
            {
                commandText = "dbo.SelectKilpStatAikaLkm";
                SqlParameter par1 = new SqlParameter("@Aika", osat[1]);
                SqlParameter par2 = new SqlParameter("@Cus", osat[2]);
                SqlParameter par3 = new SqlParameter("@Hevosid", Convert.ToInt32(osat[3]));
                pars = new SqlParameter[]
            ...
            using (SqlCommand cmd = new SqlCommand(commandText, conn))
            {
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        KilpStat tieto = new KilpStat();
                        tieto.Sijoitus = (int)reader["Sijoitus"];
                ...
                Array.Resize<KilpStat>(ref res, k);
                return res;
            }
        }
