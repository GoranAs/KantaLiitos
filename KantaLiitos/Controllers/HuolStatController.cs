...
{
    public class HuolStatController : ApiController
    {
        // GET api/<controller>
        [HttpGet]
        public string Get()
        {
            return "Huolto status";
        }

        // GET api/<controller>/5
        [HttpGet]
        public HuolStat[] Get(string id)
        {
            HuolStat[] res = new HuolStat[103];
            ...
            if (osat[0] == "1")
            {
                commandText = "dbo.SelectHuolStat";
            ...
            {
                commandText = "dbo.SelectHuolStatLkm";
                SqlParameter par1 = new SqlParameter("@Cus", osat[1]);
                SqlParameter par2 = new SqlParameter("@Hevosid", Convert.ToInt32(osat[2]));
                pars = new SqlParameter[]
                {
            ...
            {
                commandText = "dbo.SelectHuolStatAika";
            ...
            {
                commandText = "dbo.SelectHuolStatAikaLkm";
                SqlParameter par1 = new SqlParameter("@Aika", osat[1]);
                SqlParameter par2 = new SqlParameter("@Cus", osat[2]);
                SqlParameter par3 = new SqlParameter("@Hevosid", Convert.ToInt32(osat[3]));
                pars = new SqlParameter[]
            ...
            using (SqlCommand cmd = new SqlCommand(commandText, conn))
            {
                ...
                Array.Resize<HuolStat>(ref res, k);
                return res;
            }
        }
